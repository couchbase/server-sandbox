...
You should need nothing installed on your machine except Docker. Type:
    ...
    docker run -d --name couchbase-sandbox -p 8091-8094:8091-8094 -p 11210:11210 -v $(pwd)/couchbase_demo:/opt/couchbase/var couchbase/server-sandbox:6.5.0-beta

(Replace "6.5.0-beta" with the version of Couchbase Server you wish to explore.)
